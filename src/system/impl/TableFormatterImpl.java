...
class TableFormatterImpl implements TableFormatter {
	...
	public TableFormatter hdr( String... headers ) {
		...
		String sep_ = allSeps? "|" : " ";
		String sep1 = sep_;
		for(int ih = allSeps? 1 : 0; ih < len && ( col < cols || Objects.requireNonNull(headers[ih]).length() == 1 ); ih++ ) {
	...
	private String pat( String pat, int i, String c12 ) {
		return pat == null? i % 2 == 0? String.valueOf( c12.charAt(0) ) : String.valueOf( c12.charAt(1) ) :
